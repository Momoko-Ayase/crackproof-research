...
Protected product names, deployment-specific driver names, and identifying sample details are omitted. The research pages do not name the implementation projects used to verify them; the Senbei section separately documents the project's own static unpacker.
