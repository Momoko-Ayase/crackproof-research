...
The bootstrap doesn't expose one stable table at a fixed offset. It decrypts several stages, and later stages contain the records and transform programs required to recover the original sections.
