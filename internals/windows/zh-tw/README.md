...
* 諸如 `info[3]` 的名稱指從加密文件頭派生的 8-dword 表中的條目（見[受保護文件格式](file-structure/file-format.md)）。
...
Windows 數據變換頁面對應的測試代碼發佈在[驗證與參考](https://app.gitbook.com/s/2p7kzW649ZlKfmpYdJ87/)中。
