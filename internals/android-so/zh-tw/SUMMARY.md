...
* [CrackProof for Android SO 內部機制](README.md)

## 文件格式 <a href="#file-format" id="file-format"></a>

* [概覽](file-format/file-format.md)
* [受保護 ELF](file-format/protected-elf.md)
* [第一階段首部](file-format/stage1.md)
* [第二階段記錄流](file-format/stage2-streams.md)
...
## 恢復 <a href="#restoration" id="restoration"></a>

* [概覽](restoration/restoration.md)
* [模塊記錄流](restoration/module-streams.md)
