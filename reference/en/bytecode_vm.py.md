...
The bytecode VM that decodes each build's unique x86 stub, as documented in [Bytecode transforms](https://app.gitbook.com/s/PuKTEy2soDgSB3qfWACy/data-transforms/bytecode-transform).
