...
The bytecode VM that decodes each build's unique x86 stub, as documented in [Data transformation primitives](https://launchcore.gitbook.io/crackproof-research/internals/en/primitives#the-per-build-bytecode-permutation).
