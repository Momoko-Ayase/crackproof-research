...
The bytecode VM that decodes each build's unique x86 stub, as documented in [Per-build byte transform](https://app.gitbook.com/s/PuKTEy2soDgSB3qfWACy/data-transforms/bytecode-transform).
