---
description: "逐構建的自定義字節變換：x86 樁解碼器、解釋器、翻譯表與逆變換鏈。"
---

# bytecode\_vm.py

這是解碼每個構建獨有 x86 樁的字節碼 VM，記載見 [按構建定製的字節變換](https://app.gitbook.com/s/sFi4W2Zr1UBoxZd5YI3A/data-transforms/bytecode-transform)。
