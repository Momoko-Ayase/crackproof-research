---
description: "基于内容识别并分类受保护文件（KONN magic、EXE/DLL、托管/原生）。"
---

# detect.py

[受保护文件格式](https://launchcore.gitbook.io/crackproof-research/docs/file-format#recognition-and-classification)中记载的识别与分类逻辑。
