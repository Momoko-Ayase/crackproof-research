---
description: "CBC 模式的 AES 解密，密钥调度内置于数据缓冲区；T 表由 GF(2^8) 运算生成。"
---

# aes\_impl.py

分组密码：AES-CBC 解密，密钥调度嵌入数据缓冲区，见[数据变换原语](https://app.gitbook.com/s/fEb9nKPvKsjkPAHMUbOt/primitives#fen-zu-mi-ma-nei-qian-mi-yao-diao-du-de-aescbc)。
